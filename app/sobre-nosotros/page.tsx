...
export const metadata = {
  ...
  description:
    'Conoce SOHO Cambados: cocina urbana, pedidos online y recogida en local en Calle A Mariña, 3, Cambados.',
  alternates: {
      ...
      <section className="relative overflow-hidden bg-neutral-950 bg-[url('/soho-wall-logo.jpg')] bg-cover bg-center px-4 py-20 text-white md:bg-[center_44%]">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mt-7 max-w-3xl text-lg font-semibold leading-8 text-white/85">
            SOHO Cambados nace como un punto de encuentro para disfrutar
            hamburguesas, entrantes y platos preparados con una propuesta
            directa: buena comida, pedido sencillo y recogida cómoda en local.
          </p>

          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              href="/menu"
              className="rounded-2xl bg-white px-7 py-4 font-black text-neutral-950 shadow-xl transition hover:-translate-y-0.5 hover:bg-cyan-50"
            >
              Ver carta
            </Link>
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-4 py-16 md:grid-cols-3">
        <article className="rounded-[2rem] border border-black/10 bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 text-sm font-semibold leading-7 text-neutral-600">
            Trabajamos una carta pensada para disfrutar sin complicaciones:
            productos reconocibles, sabores potentes y opciones fáciles de
            pedir desde cualquier dispositivo.
          </p>
        </article>
        ...
        <article className="rounded-[2rem] border border-black/10 bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 text-sm font-semibold leading-7 text-neutral-600">
            La web permite preparar el pedido, pagar online y seguir el estado
            para saber cuándo está aceptado, en preparación o listo para
            recoger.
          </p>
        </article>
        ...
        <article className="rounded-[2rem] border border-black/10 bg-white p-8 shadow-sm">
          ...
          <h2 className="mt-6 text-2xl font-black text-neutral-950">
            En el centro de Cambados
          </h2>

          <p className="mt-3 text-sm font-semibold leading-7 text-neutral-600">
            Estamos en Calle A Mariña, 3, Cambados. Puedes pedir para recogida
            en local y, si prefieres domicilio, acceder al canal de reparto
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16">
        <div className="overflow-hidden rounded-[2rem] border border-black/10 bg-white shadow-sm md:grid md:grid-cols-[1.1fr_0.9fr]">
          <div className="p-8 md:p-10">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-[#049ca5]">
              Nuestra forma de trabajar
            </p>

            <h2 className="mt-3 text-4xl font-black tracking-tight text-neutral-950">
              Rápido, sencillo y bien explicado.
            </h2>

            <p className="mt-4 text-base font-semibold leading-8 text-neutral-600">
              Queremos que pedir en SOHO sea tan fácil como elegir, pagar y
              recoger. Por eso el sistema muestra el estado del pedido y el
              tiempo estimado cuando el equipo confirma la preparación.
            </p>
            ...
            <div className="mt-7 grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl bg-neutral-950 p-6 text-white">
                ...
                <p className="mt-2 text-sm font-semibold leading-6 text-white/75">
                  El equipo puede indicar el tiempo de preparación para que
              ...
              <div className="rounded-3xl bg-[#049ca5] p-6 text-white">
                ...
                <p className="mt-2 text-sm font-semibold leading-6 text-white/85">
                  Cada pedido tiene su página de seguimiento para consultar los
                  cambios importantes.
                </p>
              </div>
            </div>
          ...
          <div className="bg-[radial-gradient(circle_at_top,rgba(249,115,22,0.35),transparent_32%),linear-gradient(160deg,#111214,#000)] p-8 text-white md:p-10">
            ...
            <h3 className="mt-4 text-3xl font-black leading-tight">
              Una experiencia pensada para el cliente y para el ritmo real de
              cocina.
            </h3>

            <p className="mt-5 text-sm font-semibold leading-7 text-white/75">
              Si tienes cualquier duda sobre carta, horarios, pedidos o
              recogida, puedes usar el formulario de contacto de la web y el
              equipo recibirá tu mensaje directamente.
            </p>

            <Link
              href="/#contacto"
              className="mt-7 inline-flex rounded-2xl bg-white px-6 py-4 text-sm font-black text-neutral-950 transition hover:-translate-y-0.5 hover:bg-cyan-50"
            >
              Enviar mensaje
            </Link>
          </div>
