...
export const metadata: Metadata = {
  ...
  title: {
    default: 'SOHO Cambados | Cafetería y hamburguesería',
    template: '%s | SOHO Cambados'
  },

  description:
    'Cafetería y hamburguesería en Cambados. Consulta la carta de SOHO, pide hamburguesas, bocadillos y platos online y recoge en A Mariña, 3.',

  applicationName: 'SOHO Cambados',
  keywords: [
    'SOHO Cambados',
    'cafetería en Cambados',
    'hamburguesas en Cambados',
    'comida para recoger en Cambados',
    'carta SOHO Cambados',
    'bocadillos en Cambados'
  ],
  ...
  openGraph: {
    ...
    title: 'SOHO Cambados | Cafetería y hamburguesería',
    description:
      'Consulta la carta, pide hamburguesas, bocadillos y platos online y recoge en el local de Cambados.',
    url: siteUrl,
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'SOHO Cambados, cafetería y hamburguesería en A Mariña'
      }
    ]
  },
  ...
  twitter: {
    ...
    title: 'SOHO Cambados | Cafetería y hamburguesería',
    description: 'Consulta la carta y pide online para recoger en SOHO Cambados.',
...
export default function RootLayout({
  ...
  const structuredData = {
    ...
    image: [
      ...
      new URL(siteConfig.compactLogoPath, siteUrl).toString()
    ],
    logo: new URL(siteConfig.compactLogoPath, siteUrl).toString(),
