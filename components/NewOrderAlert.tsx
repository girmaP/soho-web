...
export function NewOrderAlert({ orders, onAcknowledged }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[90] grid animate-[soho-page-in_220ms_ease-out_both] place-items-center bg-black/55 p-4 backdrop-blur-sm" role="alertdialog" aria-modal="true" aria-label="Pedidos nuevos pendientes de confirmar">
      <div className="max-h-[92vh] w-full max-w-xl animate-[soho-cart-pop_360ms_cubic-bezier(.2,.8,.2,1)_both] overflow-auto rounded-[32px] bg-white p-6 shadow-2xl ring-4 ring-amber-400/80">
